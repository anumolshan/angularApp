...
@Component({
  selector: 'app-view-vontra-vouchers',
  templateUrl: './view-contra-vouchers.component.html',
  styleUrls: ['./view-contra-vouchers.component.scss']
})
export class ViewContraVouchersComponent implements OnInit {
  isSpinner: boolean;
  journalList: any[] = [];
  ...
  constructor(public commonService: CommonService, public messageService: MessageService, public translateService: TranslateService,
    ...
    private confirmationService: ConfirmationService) {
      this.breadcrumbService.setItems([
        ...
        { label: 'side_menu.contra_vouchers' }
      ]);
